...
<!--paginetation-->
    ...
    echo " <span class=paginetation > <a href='allcat.php?page=1 '>First Page</a>";

    for ($i=1; $i<= $total_page; $i++) { 
     echo "<a href='allcat.php?page=".$i." '>".$i. ">></a>";
     } 


     echo "<a href='allcat.php?page=$total_page '>Last Page</a></span>"?>
    <!--paginetation-->
    <?php //} ?>
